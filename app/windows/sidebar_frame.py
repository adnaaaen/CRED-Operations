...
from .create.create_window import AddNewBook
from .delete.delete_window import DeleteBook
from .update.update_window import UpdateBook
from .search.search_window import SearchBook
...
class SideBar(ctk.CTkFrame):
    ...
    def create_window(self):
        if self.toplevel_window is None or not self.toplevel_window.winfo_exists():
            self.toplevel_window = AddNewBook(self) 
        else:
